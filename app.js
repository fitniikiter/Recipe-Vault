      ...
      function buildAllCards() {
        ...
        (R.forEach((e) => {
          ...
          (r && r.image
            ...
            : r &&
              r.video &&
              (c = `<div class="card-thumb-wrap"><img class="card-thumb" src="https://img.youtube.com/vi/${r.video}/hqdefault.jpg" loading="lazy" alt="${e.title}"><div class="play-overlay"><span>▶️</span></div></div>`),
